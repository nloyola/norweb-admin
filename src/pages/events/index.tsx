...
const EventsPage = ({ total, next, results }: PaginatedResponse<IEvent>) => {
...
export const getServerSideProps: GetServerSideProps = async ({ query }: GetServerSidePropsContext) => {
    ...
    const apiUrl = (server: string, page: string | string[]) => `${server}/api/events/?page=${page}`;
    ...
    const response: PaginatedResponse<IEvent> = await res.json();
